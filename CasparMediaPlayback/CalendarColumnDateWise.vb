Public Class CalendarColumnDateWise
    Inherits DataGridViewColumn

    Public Sub New()
        MyBase.New(New CalendarCellDateWise())
    End Sub
...
Public Class CalendarCellDateWise
    ...
    Public Overrides Sub InitializeEditingControl(ByVal rowIndex As Integer,
        ...
        Dim ctl As CalendarEditingControlDateWise =
            CType(DataGridView.EditingControl, CalendarEditingControlDateWise)
    ...
    Public Overrides ReadOnly Property EditType() As Type
        Get
            ...
            Return GetType(CalendarEditingControlDateWise)
        End Get
    End Property
...
Public Class CalendarEditingControlDateWise
    ...
    Public Sub New()
        ...
        Me.CustomFormat = "dd/MM/yyyy HH:mm:ss"
        Me.ShowUpDown = True
    End Sub
