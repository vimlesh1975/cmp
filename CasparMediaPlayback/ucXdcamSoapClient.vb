...
Public Class ucXdcamSoapClient
    ...
    Private Sub cmdCueFromPlaylist_Click(sender As Object, e As EventArgs) Handles cmdCueFromPlaylist.Click
        On Error Resume Next
        currrow = dgv1.CurrentRow.Index
    ...
    Private Sub cmdCueFromClipGrid_Click(sender As Object, e As EventArgs) Handles cmdCueFromClipGrid.Click
        On Error Resume Next
