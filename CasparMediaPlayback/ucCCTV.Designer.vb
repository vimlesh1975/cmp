...
Partial Class ucCCTV
    ...
    Friend WithEvents cmd49 As Button
    Friend WithEvents cmd48 As Button
    Friend WithEvents cmd43 As Button
    Friend WithEvents cmd42 As Button
    Friend WithEvents cmd41 As Button
    Friend WithEvents cmd40 As Button
    Friend WithEvents cmd39 As Button
    Friend WithEvents cmd38 As Button
    Friend WithEvents cmd37 As Button
    Friend WithEvents cmd36 As Button
    Friend WithEvents cmd35 As Button
    Friend WithEvents cmd34 As Button
    Friend WithEvents cmd33 As Button
    Friend WithEvents cmd32 As Button
    Friend WithEvents cmd31 As Button
    Friend WithEvents cmd30 As Button
    Friend WithEvents cmd29 As Button
    Friend WithEvents cmd28 As Button
    Friend WithEvents cmd27 As Button
    Friend WithEvents cmd26 As Button
    Friend WithEvents cmd25 As Button
    Friend WithEvents cmd24 As Button
    Friend WithEvents cmd23 As Button
    Friend WithEvents cmd22 As Button
    Friend WithEvents cmd21 As Button
    Friend WithEvents cmd20 As Button
    Friend WithEvents cmdStopall As Button
    Friend WithEvents Label9 As Label
    Friend WithEvents cmdEditCameraList As Button
    Friend WithEvents cmdOpenCameraList As Button
    Friend WithEvents tmrSwitch As Timer
    Friend WithEvents txtTotalCameras As TextBox
    Friend WithEvents txtIpNetwork As TextBox
    Friend WithEvents txtipport As TextBox
    Friend WithEvents txtPassword As TextBox
    Friend WithEvents txtUserName As TextBox
    Friend WithEvents Label1 As Label
    Friend WithEvents cmd47 As Button
    Friend WithEvents cmd46 As Button
    Friend WithEvents cmd45 As Button
    Friend WithEvents cmd44 As Button
End Class
