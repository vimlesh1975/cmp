...
Public Class ucMixer
    ...
    Private Sub cmdplayfilter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdplayfilter.Click
        If ServerVersion > 2.1 Then
            CasparDevice.SendString("play " & g_int_ChannelNumber & "-" & cmbvideolayerformixer.Text & " " & cmbmediaforfilter.Text & " loop vf " & cmbfilter.Text)
        Else
            CasparDevice.SendString("play " & g_int_ChannelNumber & "-" & cmbvideolayerformixer.Text & " " & cmbmediaforfilter.Text & " loop filter " & cmbfilter.Text)
        End If
